...
The tables and figures presented in the annual publications can vary from year to year. This means that not all of the tables/figures from each year will be in this app. Most tables and figures contain data going back to 2013 for comparing between two years.
