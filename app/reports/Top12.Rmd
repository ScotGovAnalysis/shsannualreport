...
if (!is.null(Figure_12.1)) {
Figure_12.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_12.1)), escape = TRUE, booktabs = T)
 } else {
...
if (!is.null(Figure_12.1)) {
if (length(grep("_2", colnames(Figure_12.1))) > 0) {
colnames(Figure_12.1) <- gsub("%", "\\\\%", colnames(Figure_12.1))
...
```{r eval=eval_comparison_time_series}
if (!is.null(Figure_12.1) && length(grep("_2", colnames(Figure_12.1))) > 0) {
...
```{r eval=(eval_comparison_time_series == FALSE)}
if (!is.null(Table_12.1)) {
Table_12.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.1)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison_time_series}
if (!is.null(Table_12.1)) {
if (length(grep("_2", colnames(Table_12.1))) > 0) {
colnames(Table_12.1) <- gsub("%", "\\\\%", colnames(Table_12.1))
...
```{r eval=eval_comparison_time_series}
if (!is.null(Table_12.1) && length(grep("_2", colnames(Table_12.1))) > 0) {
...
if (!is.null(Figure_12.2)) {
Figure_12.2 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_12.2)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
if (!is.null(Figure_12.2)) {
if (length(grep("_2", colnames(Figure_12.2))) > 0) {
colnames(Figure_12.2) <- gsub("%", "\\\\%", colnames(Figure_12.2))
...
```{r eval=eval_comparison}
if (!is.null(Figure_12.2) && length(grep("_2", colnames(Figure_12.2))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.2)) {
Table_12.2 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.2)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.2)) {
if (length(grep("_2", colnames(Table_12.2))) > 0) {
colnames(Table_12.2) <- gsub("%", "\\\\%", colnames(Table_12.2))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.2) && length(grep("_2", colnames(Table_12.2))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.3)) {
Table_12.3 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.3)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.3)) {
if (length(grep("_2", colnames(Table_12.3))) > 0) {
colnames(Table_12.3) <- gsub("%", "\\\\%", colnames(Table_12.3))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.3) && length(grep("_2", colnames(Table_12.3))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.4_Figure_12.3)) {
Table_12.4_Figure_12.3 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.4_Figure_12.3)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.4_Figure_12.3)) {
if (length(grep("_2", colnames(Table_12.4_Figure_12.3))) > 0) {
colnames(Table_12.4_Figure_12.3) <- gsub("%", "\\\\%", colnames(Table_12.4_Figure_12.3))
...
mutate(`HNC/HND/Degree/Professional Qualification` = cell_spec(`HNC/HND/Degree/Professional Qualification`, "latex", background = case_when(`HNC/HND/Degree/Professional Qualification_sig` == "HIGHER" ~ "#00A3A3", `HNC/HND/Degree/Professional Qualification_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
...
```{r eval=eval_comparison}
if (!is.null(Table_12.4_Figure_12.3) && length(grep("_2", colnames(Table_12.4_Figure_12.3))) > 0) {
...
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`HNC/HND/Degree/Professional Qualification` = cell_spec(`HNC/HND/Degree/Professional Qualification`, "latex", background = case_when(`HNC/HND/Degree/Professional Qualification_sig` == "HIGHER" ~ "#C3C3FF", `HNC/HND/Degree/Professional Qualification_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.5_Figure_12.4)) {
Table_12.5_Figure_12.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.5_Figure_12.4)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.5_Figure_12.4)) {
if (length(grep("_2", colnames(Table_12.5_Figure_12.4))) > 0) {
colnames(Table_12.5_Figure_12.4) <- gsub("%", "\\\\%", colnames(Table_12.5_Figure_12.4))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.5_Figure_12.4) && length(grep("_2", colnames(Table_12.5_Figure_12.4))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.6_Figure_12.5)) {
Table_12.6_Figure_12.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.6_Figure_12.5)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.6_Figure_12.5)) {
if (length(grep("_2", colnames(Table_12.6_Figure_12.5))) > 0) {
colnames(Table_12.6_Figure_12.5) <- gsub("%", "\\\\%", colnames(Table_12.6_Figure_12.5))
...
mutate(`GBP 0 - GBP 10,000` = cell_spec(`GBP 0 - GBP 10,000`, "latex", background = case_when(`GBP 0 - GBP 10,000_sig` == "HIGHER" ~ "#00A3A3", `GBP 0 - GBP 10,000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
`GBP 10,001 to GBP 20,000` = cell_spec(`GBP 10,001 to GBP 20,000`, "latex", background = case_when(`GBP 10,001 to GBP 20,000_sig` == "HIGHER" ~ "#00A3A3", `GBP 10,001 to GBP 20,000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
`GBP 20,001 to GBP 30,000` = cell_spec(`GBP 20,001 to GBP 30,000`, "latex", background = case_when(`GBP 20,001 to GBP 30,000_sig` == "HIGHER" ~ "#00A3A3", `GBP 20,001 to GBP 30,000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
...
```{r eval=eval_comparison}
if (!is.null(Table_12.6_Figure_12.5) && length(grep("_2", colnames(Table_12.6_Figure_12.5))) > 0) {
...
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`GBP 0 - GBP 10,000` = cell_spec(`GBP 0 - GBP 10,000`, "latex", background = case_when(`GBP 0 - GBP 10,000_sig` == "HIGHER" ~ "#C3C3FF", `GBP 0 - GBP 10,000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
`GBP 10,001 to GBP 20,000` = cell_spec(`GBP 10,001 to GBP 20,000`, "latex", background = case_when(`GBP 10,001 to GBP 20,000_sig` == "HIGHER" ~ "#C3C3FF", `GBP 10,001 to GBP 20,000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
`GBP 20,001 to GBP 30,000` = cell_spec(`GBP 20,001 to GBP 30,000`, "latex", background = case_when(`GBP 20,001 to GBP 30,000_sig` == "HIGHER" ~ "#C3C3FF", `GBP 20,001 to GBP 30,000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.7_Figure_12.6)) {
Table_12.7_Figure_12.6 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.7_Figure_12.6)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.7_Figure_12.6)) {
if (length(grep("_2", colnames(Table_12.7_Figure_12.6))) > 0) {
colnames(Table_12.7_Figure_12.6) <- gsub("%", "\\\\%", colnames(Table_12.7_Figure_12.6))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.7_Figure_12.6) && length(grep("_2", colnames(Table_12.7_Figure_12.6))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.8)) {
Table_12.8 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.8)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.8)) {
if (length(grep("_2", colnames(Table_12.8))) > 0) {
colnames(Table_12.8) <- gsub("%", "\\\\%", colnames(Table_12.8))
...
`Do not know` = cell_spec(`Do not know`, "latex", background = case_when(`Do not know_sig` == "HIGHER" ~ "#00A3A3", `Do not know_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
...
```{r eval=eval_comparison}
if (!is.null(Table_12.8) && length(grep("_2", colnames(Table_12.8))) > 0) {
...
`Do not know` = cell_spec(`Do not know`, "latex", background = case_when(`Do not know_sig` == "HIGHER" ~ "#C3C3FF", `Do not know_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
...
```{r eval=(eval_comparison_time_series == FALSE)}
if (!is.null(Table_12.9)) {
Table_12.9 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.9)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison_time_series}
if (!is.null(Table_12.9)) {
if (length(grep("_2", colnames(Table_12.9))) > 0) {
colnames(Table_12.9) <- gsub("%", "\\\\%", colnames(Table_12.9))
...
```{r eval=eval_comparison_time_series}
if (!is.null(Table_12.9) && length(grep("_2", colnames(Table_12.9))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Figure_12.7)) {
Figure_12.7 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_12.7)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Figure_12.7)) {
if (length(grep("_2", colnames(Figure_12.7))) > 0) {
colnames(Figure_12.7) <- gsub("%", "\\\\%", colnames(Figure_12.7))
...
```{r eval=eval_comparison}
if (!is.null(Figure_12.7) && length(grep("_2", colnames(Figure_12.7))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.10)) {
Table_12.10 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.10)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.10)) {
if (length(grep("_2", colnames(Table_12.10))) > 0) {
colnames(Table_12.10) <- gsub("%", "\\\\%", colnames(Table_12.10))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.10) && length(grep("_2", colnames(Table_12.10))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.11)) {
Table_12.11 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.11)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.11)) {
if (length(grep("_2", colnames(Table_12.11))) > 0) {
colnames(Table_12.11) <- gsub("%", "\\\\%", colnames(Table_12.11))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.11) && length(grep("_2", colnames(Table_12.11))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.12_Figure_12.8)) {
Table_12.12_Figure_12.8 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.12_Figure_12.8)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.12_Figure_12.8)) {
if (length(grep("_2", colnames(Table_12.12_Figure_12.8))) > 0) {
colnames(Table_12.12_Figure_12.8) <- gsub("%", "\\\\%", colnames(Table_12.12_Figure_12.8))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.12_Figure_12.8) && length(grep("_2", colnames(Table_12.12_Figure_12.8))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.13_Figure_12.9)) {
Table_12.13_Figure_12.9 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.13_Figure_12.9)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.13_Figure_12.9)) {
if (length(grep("_2", colnames(Table_12.13_Figure_12.9))) > 0) {
colnames(Table_12.13_Figure_12.9) <- gsub("%", "\\\\%", colnames(Table_12.13_Figure_12.9))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.13_Figure_12.9) && length(grep("_2", colnames(Table_12.13_Figure_12.9))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.14_Figure_12.10)) {
Table_12.14_Figure_12.10 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.14_Figure_12.10)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.14_Figure_12.10)) {
if (length(grep("_2", colnames(Table_12.14_Figure_12.10))) > 0) {
colnames(Table_12.14_Figure_12.10) <- gsub("%", "\\\\%", colnames(Table_12.14_Figure_12.10))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.14_Figure_12.10) && length(grep("_2", colnames(Table_12.14_Figure_12.10))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.15_Figure_12.11)) {
Table_12.15_Figure_12.11 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.15_Figure_12.11)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.15_Figure_12.11)) {
if (length(grep("_2", colnames(Table_12.15_Figure_12.11))) > 0) {
colnames(Table_12.15_Figure_12.11) <- gsub("%", "\\\\%", colnames(Table_12.15_Figure_12.11))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.15_Figure_12.11) && length(grep("_2", colnames(Table_12.15_Figure_12.11))) > 0) {
...
```{r eval=(eval_comparison == FALSE)}
if (!is.null(Table_12.16)) {
Table_12.16 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.16)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison}
if (!is.null(Table_12.16)) {
if (length(grep("_2", colnames(Table_12.16))) > 0) {
colnames(Table_12.16) <- gsub("%", "\\\\%", colnames(Table_12.16))
...
```{r eval=eval_comparison}
if (!is.null(Table_12.16) && length(grep("_2", colnames(Table_12.16))) > 0) {
...
```{r eval=(eval_comparison_time_series == FALSE)}
if (!is.null(Table_12.17)) {
Table_12.17 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.17)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison_time_series}
if (!is.null(Table_12.17)) {
if (length(grep("_2", colnames(Table_12.17))) > 0) {
colnames(Table_12.17) <- gsub("%", "\\\\%", colnames(Table_12.17))
...
```{r eval=eval_comparison_time_series}
if (!is.null(Table_12.17) && length(grep("_2", colnames(Table_12.17))) > 0) {
...
```{r eval=(eval_comparison_time_series == FALSE)}
if (!is.null(Table_12.18)) {
Table_12.18 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_12.18)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
```{r eval=eval_comparison_time_series}
if (!is.null(Table_12.18)) {
if (length(grep("_2", colnames(Table_12.18))) > 0) {
colnames(Table_12.18) <- gsub("%", "\\\\%", colnames(Table_12.18))
...
```{r eval=eval_comparison_time_series}
if (!is.null(Table_12.18) && length(grep("_2", colnames(Table_12.18))) > 0) {
