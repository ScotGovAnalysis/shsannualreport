...
mutate(`£0 - £10,000` = cell_spec(`£0 - £10,000`, "latex", background = case_when(`£0 - £10,000_sig` == "HIGHER" ~ "#00A3A3", `£0 - £10,000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
`£10,001 to £20,000` = cell_spec(`£10,001 to £20,000`, "latex", background = case_when(`£10,001 to £20,000_sig` == "HIGHER" ~ "#00A3A3", `£10,001 to £20,000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
`£20,001 to £30,000` = cell_spec(`£20,001 to £30,000`, "latex", background = case_when(`£20,001 to £30,000_sig` == "HIGHER" ~ "#00A3A3", `£20,001 to £30,000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
...
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`£0 - £10,000` = cell_spec(`£0 - £10,000`, "latex", background = case_when(`£0 - £10,000_sig` == "HIGHER" ~ "#C3C3FF", `£0 - £10,000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
`£10,001 to £20,000` = cell_spec(`£10,001 to £20,000`, "latex", background = case_when(`£10,001 to £20,000_sig` == "HIGHER" ~ "#C3C3FF", `£10,001 to £20,000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
`£20,001 to £30,000` = cell_spec(`£20,001 to £30,000`, "latex", background = case_when(`£20,001 to £30,000_sig` == "HIGHER" ~ "#C3C3FF", `£20,001 to £30,000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
