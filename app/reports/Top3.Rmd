...
Figure_3.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_3.1)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
...
Table_3.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.1)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down") %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.1)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em") %>% kable_styling(latex_options = "scale_down")
}
} else {
  asis_output("### There is no data to show for this table within the specified parameters.")
}
...
kable("latex", col.names = gsub("blank", "", colnames(Table_3.1b)), escape = FALSE, booktabs = T) %>% column_spec(1, width = "20em") %>% kable_styling(latex_options = "scale_down")
```
```{r eval=eval_comparison_time_series}
...
Figure_3.2 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_3.2)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_3.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_3.4)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_3.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_3.5)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.2a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.2a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.2b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.2b)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.2c %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.2c)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.2d %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.2d)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.3a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.3a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.3b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.3b)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.3c %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.3c)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.3d %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.3d)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.3e %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.3e)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.3f %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.3f)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.4a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.4a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.4b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.4b)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.4c %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.4c)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.5a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.5a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.5b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.5b)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.6a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.6a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.6b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.6b)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_3.6 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_3.6)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.7a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.7a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.7b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.7b)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.7c %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.7c)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.9a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.9a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.10a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.10a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.10b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.10b)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.11a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.11a)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.11b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.11b)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.12 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.12)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_3.13 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_3.13)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
