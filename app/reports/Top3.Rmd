...
Figure_3.1 %>% select(all_of(main_column_names)) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#00A3A3", `1999_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#00A3A3", `2000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#00A3A3", `2001_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2002` = cell_spec(`2002`, "latex", background = case_when(`2002_sig` == "HIGHER" ~ "#00A3A3", `2002_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2003` = cell_spec(`2003`, "latex", background = case_when(`2003_sig` == "HIGHER" ~ "#00A3A3", `2003_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2004` = cell_spec(`2004`, "latex", background = case_when(`2004_sig` == "HIGHER" ~ "#00A3A3", `2004_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2005` = cell_spec(`2005`, "latex", background = case_when(`2005_sig` == "HIGHER" ~ "#00A3A3", `2005_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2006` = cell_spec(`2006`, "latex", background = case_when(`2006_sig` == "HIGHER" ~ "#00A3A3", `2006_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2007` = cell_spec(`2007`, "latex", background = case_when(`2007_sig` == "HIGHER" ~ "#00A3A3", `2007_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2008` = cell_spec(`2008`, "latex", background = case_when(`2008_sig` == "HIGHER" ~ "#00A3A3", `2008_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2009` = cell_spec(`2009`, "latex", background = case_when(`2009_sig` == "HIGHER" ~ "#00A3A3", `2009_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2010` = cell_spec(`2010`, "latex", background = case_when(`2010_sig` == "HIGHER" ~ "#00A3A3", `2010_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
...
Figure_3.1 %>% select(all_of(colnames(Figure_3.1)[!colnames(Figure_3.1) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#C3C3FF", `1999_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#C3C3FF", `2000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#C3C3FF", `2001_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2002` = cell_spec(`2002`, "latex", background = case_when(`2002_sig` == "HIGHER" ~ "#C3C3FF", `2002_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2003` = cell_spec(`2003`, "latex", background = case_when(`2003_sig` == "HIGHER" ~ "#C3C3FF", `2003_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2004` = cell_spec(`2004`, "latex", background = case_when(`2004_sig` == "HIGHER" ~ "#C3C3FF", `2004_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2005` = cell_spec(`2005`, "latex", background = case_when(`2005_sig` == "HIGHER" ~ "#C3C3FF", `2005_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2006` = cell_spec(`2006`, "latex", background = case_when(`2006_sig` == "HIGHER" ~ "#C3C3FF", `2006_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2007` = cell_spec(`2007`, "latex", background = case_when(`2007_sig` == "HIGHER" ~ "#C3C3FF", `2007_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2008` = cell_spec(`2008`, "latex", background = case_when(`2008_sig` == "HIGHER" ~ "#C3C3FF", `2008_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2009` = cell_spec(`2009`, "latex", background = case_when(`2009_sig` == "HIGHER" ~ "#C3C3FF", `2009_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2010` = cell_spec(`2010`, "latex", background = case_when(`2010_sig` == "HIGHER" ~ "#C3C3FF", `2010_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.1 %>% select(all_of(main_column_names)) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#00A3A3", `1999_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#00A3A3", `2000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#00A3A3", `2001_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2002` = cell_spec(`2002`, "latex", background = case_when(`2002_sig` == "HIGHER" ~ "#00A3A3", `2002_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
...
Table_3.1 %>% select(all_of(colnames(Table_3.1)[!colnames(Table_3.1) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#C3C3FF", `1999_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#C3C3FF", `2000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#C3C3FF", `2001_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
### 1999-2000 estimates are based on 2001 census data, all other years are based on 2011 census data
...
Figure_3.2 %>% select(all_of(main_column_names)) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#00A3A3", `1999_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#00A3A3", `2000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#00A3A3", `2001_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2002` = cell_spec(`2002`, "latex", background = case_when(`2002_sig` == "HIGHER" ~ "#00A3A3", `2002_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
...
Figure_3.2 %>% select(all_of(colnames(Figure_3.2)[!colnames(Figure_3.2) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#C3C3FF", `1999_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#C3C3FF", `2000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#C3C3FF", `2001_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Figure_3.4 %>% select(all_of(main_column_names)) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#00A3A3", `1999_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#00A3A3", `2000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#00A3A3", `2001_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2002` = cell_spec(`2002`, "latex", background = case_when(`2002_sig` == "HIGHER" ~ "#00A3A3", `2002_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
...
Figure_3.4 %>% select(all_of(colnames(Figure_3.4)[!colnames(Figure_3.4) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#C3C3FF", `1999_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#C3C3FF", `2000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#C3C3FF", `2001_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Figure_3.5 %>% select(all_of(main_column_names)) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#00A3A3", `1999_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#00A3A3", `2000_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#00A3A3", `2001_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2002` = cell_spec(`2002`, "latex", background = case_when(`2002_sig` == "HIGHER" ~ "#00A3A3", `2002_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
...
Figure_3.5 %>% select(all_of(colnames(Figure_3.5)[!colnames(Figure_3.5) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`1999` = cell_spec(`1999`, "latex", background = case_when(`1999_sig` == "HIGHER" ~ "#C3C3FF", `1999_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2000` = cell_spec(`2000`, "latex", background = case_when(`2000_sig` == "HIGHER" ~ "#C3C3FF", `2000_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2001` = cell_spec(`2001`, "latex", background = case_when(`2001_sig` == "HIGHER" ~ "#C3C3FF", `2001_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.2a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
...
Table_3.2a %>% select(all_of(colnames(Table_3.2a)[!colnames(Table_3.2a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.2b %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.2b %>% select(all_of(colnames(Table_3.2b)[!colnames(Table_3.2b) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.2c %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.2c %>% select(all_of(colnames(Table_3.2c)[!colnames(Table_3.2c) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.2d %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.2d %>% select(all_of(colnames(Table_3.2d)[!colnames(Table_3.2d) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.3a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.3a %>% select(all_of(colnames(Table_3.3a)[!colnames(Table_3.3a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.3b %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.3b %>% select(all_of(colnames(Table_3.3b)[!colnames(Table_3.3b) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.3c %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.3c %>% select(all_of(colnames(Table_3.3c)[!colnames(Table_3.3c) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.3d %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.3d %>% select(all_of(colnames(Table_3.3d)[!colnames(Table_3.3d) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.3e %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.3e %>% select(all_of(colnames(Table_3.3e)[!colnames(Table_3.3e) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.3f %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.3f %>% select(all_of(colnames(Table_3.3f)[!colnames(Table_3.3f) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.4a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.4a %>% select(all_of(colnames(Table_3.4a)[!colnames(Table_3.4a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.4b %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.4b %>% select(all_of(colnames(Table_3.4b)[!colnames(Table_3.4b) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.4c %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.4c %>% select(all_of(colnames(Table_3.4c)[!colnames(Table_3.4c) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.5a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.5a %>% select(all_of(colnames(Table_3.5a)[!colnames(Table_3.5a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.5b %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.5b %>% select(all_of(colnames(Table_3.5b)[!colnames(Table_3.5b) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.6a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.6a %>% select(all_of(colnames(Table_3.6a)[!colnames(Table_3.6a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.6b %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.6b %>% select(all_of(colnames(Table_3.6b)[!colnames(Table_3.6b) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Figure_3.6 %>% select(all_of(main_column_names)) %>%
...
Figure_3.6 %>% select(all_of(colnames(Figure_3.6)[!colnames(Figure_3.6) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
...
Table_3.7a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.7a %>% select(all_of(colnames(Table_3.7a)[!colnames(Table_3.7a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.7b %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.7b %>% select(all_of(colnames(Table_3.7b)[!colnames(Table_3.7b) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.7c %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.7c %>% select(all_of(colnames(Table_3.7c)[!colnames(Table_3.7c) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.9a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.9a %>% select(all_of(colnames(Table_3.9a)[!colnames(Table_3.9a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.10a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.10a %>% select(all_of(colnames(Table_3.10a)[!colnames(Table_3.10a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.10b %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.10b %>% select(all_of(colnames(Table_3.10b)[!colnames(Table_3.10b) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.11a %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.11a %>% select(all_of(colnames(Table_3.11a)[!colnames(Table_3.11a) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.11b %>% select(all_of(main_column_names)) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#00A3A3", `Owner occupier_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#00A3A3", `Social sector_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#00A3A3", `Private rent_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`Other` = cell_spec(`Other`, "latex", background = case_when(`Other_sig` == "HIGHER" ~ "#00A3A3", `Other_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white"))
...
Table_3.11b %>% select(all_of(colnames(Table_3.11b)[!colnames(Table_3.11b) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Owner occupier` = cell_spec(`Owner occupier`, "latex", background = case_when(`Owner occupier_sig` == "HIGHER" ~ "#C3C3FF", `Owner occupier_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Social sector` = cell_spec(`Social sector`, "latex", background = case_when(`Social sector_sig` == "HIGHER" ~ "#C3C3FF", `Social sector_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`Private rent` = cell_spec(`Private rent`, "latex", background = case_when(`Private rent_sig` == "HIGHER" ~ "#C3C3FF", `Private rent_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.12 %>% select(all_of(main_column_names)) %>%
mutate(`2012` = cell_spec(`2012`, "latex", background = case_when(`2012_sig` == "HIGHER" ~ "#00A3A3", `2012_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2013` = cell_spec(`2013`, "latex", background = case_when(`2013_sig` == "HIGHER" ~ "#00A3A3", `2013_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2014` = cell_spec(`2014`, "latex", background = case_when(`2014_sig` == "HIGHER" ~ "#00A3A3", `2014_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
`2015` = cell_spec(`2015`, "latex", background = case_when(`2015_sig` == "HIGHER" ~ "#00A3A3", `2015_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "white")),
...
Table_3.12 %>% select(all_of(colnames(Table_3.12)[!colnames(Table_3.12) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`2012` = cell_spec(`2012`, "latex", background = case_when(`2012_sig` == "HIGHER" ~ "#C3C3FF", `2012_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2013` = cell_spec(`2013`, "latex", background = case_when(`2013_sig` == "HIGHER" ~ "#C3C3FF", `2013_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
`2014` = cell_spec(`2014`, "latex", background = case_when(`2014_sig` == "HIGHER" ~ "#C3C3FF", `2014_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "white")),
...
Table_3.13 %>% select(all_of(main_column_names)) %>%
...
Table_3.13 %>% select(all_of(colnames(Table_3.13)[!colnames(Table_3.13) %in% comparison_rename_column_names])) %>%
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
