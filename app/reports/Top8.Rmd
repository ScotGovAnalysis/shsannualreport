...
kable("latex", col.names = gsub("blank", "", colnames(Table_8.1_Figure_8.1_Figure_8.2)), escape = TRUE, booktabs = T)
 } else {
...
Figure_8.3 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_8.3)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_8.2 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_8.2)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_8.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_8.4)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_8.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_8.5)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_8.6 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_8.6)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_8.7 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_8.7)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_8.8 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_8.8)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_8.3 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_8.3)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_8.13 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_8.13)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_8.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_8.4)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_8.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_8.5)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
