...
Table_4.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.1)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
...
Table_4.2 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.2)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_4.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_4.1)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_4.2a %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_4.2a)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_4.2b %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_4.2b)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.3 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.3)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
mutate(`Do not know` = cell_spec(`Do not know`, "latex", background = case_when(`Do not know_sig` == "HIGHER" ~ "#00A3A3", `Do not know_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
...
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Do not know` = cell_spec(`Do not know`, "latex", background = case_when(`Do not know_sig` == "HIGHER" ~ "#C3C3FF", `Do not know_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
...
Table_4.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.4)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.5)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.6 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.6)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.7 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.7)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.8a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.8a)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down") %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
`Man / Boy` = cell_spec(`Man / Boy`, "latex", background = case_when(`Man / Boy_sig` == "HIGHER" ~ "#00A3A3", `Man / Boy_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
...
Table_4.8a %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.8a)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em") %>% kable_styling(latex_options = "scale_down")
}
} else {
  asis_output("### There is no data to show for this table within the specified parameters.")
}
...
`Man / Boy` = cell_spec(`Man / Boy`, "latex", background = case_when(`Man / Boy_sig` == "HIGHER" ~ "#C3C3FF", `Man / Boy_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
...
Table_4.8b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.8b)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down") %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.8b %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.8b)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em") %>% kable_styling(latex_options = "scale_down")
}
} else {
  asis_output("### There is no data to show for this table within the specified parameters.")
}
...
Table_4.9 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.9)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.10 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.10)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.11 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.11)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.12 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.12)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.13 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.13)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.14 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.14)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.15 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.15)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.16 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.16)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.17 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.17)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.18 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.18)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.19 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.19)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.20 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.20)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.21 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.21)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_4.3 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_4.3)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
mutate(`Perceive as very or fairly common` = cell_spec(`Perceive as very or fairly common`, "latex", background = case_when(`Perceive as very or fairly common_sig` == "HIGHER" ~ "#00A3A3", `Perceive as very or fairly common_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
...
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`Perceive as very or fairly common` = cell_spec(`Perceive as very or fairly common`, "latex", background = case_when(`Perceive as very or fairly common_sig` == "HIGHER" ~ "#C3C3FF", `Perceive as very or fairly common_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
...
Table_4.22 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.22)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.23 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.23)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.24 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.24)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.25 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.25)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.26 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.26)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.28 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.28)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_4.29 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_4.29)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
