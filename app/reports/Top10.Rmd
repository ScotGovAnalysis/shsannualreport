...
Table_10.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.1)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
...
### Column percentages, Adults
### Base sizes too small for breakdown by age
...
Figure_10.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_10.1)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
mutate(`All Ages` = cell_spec(`All Ages`, "latex", background = case_when(`All Ages_sig` == "HIGHER" ~ "#00A3A3", `All Ages_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF"))
...
rename_at(comparison_column_names, ~ comparison_rename_column_names) %>%
mutate(`All Ages` = cell_spec(`All Ages`, "latex", background = case_when(`All Ages_sig` == "HIGHER" ~ "#C3C3FF", `All Ages_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF"))) %>%
        select(!tidyselect::all_of(significance_column_names)) %>%
        kable("latex", col.names = gsub("blank", "", presentation_column_names), escape = FALSE, booktabs = T)
} else {
asis_output("### There is no data to show for this table within the specified parameters, or there is no data to compare with.")
...
Table_10.2 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.2)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.3 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.3)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.4)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.5)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.6 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.6)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.7 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.7)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_10.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_10.4)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.8 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.8)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.9 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.9)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.10 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.10)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_10.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_10.5)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.11 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.11)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_10.6 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_10.6)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_10.7 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_10.7)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.12 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.12)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_10.13 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_10.13)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
