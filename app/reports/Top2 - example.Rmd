...
``` {r}
main_la_significance_key <- asis_output(paste0("```{=latex}
$ \\color[RGB]{0, 163, 163} \\blacksquare $ Significantly greater than ", comparator, "(", year, ")  $ \\color[RGB]{195, 195, 255} \\blacksquare $ Significantly lower than ", comparator, "
```"))

comparison_la_significance_key <- asis_output(paste0("```{=latex}
$ \\color[RGB]{0, 163, 163} \\blacksquare $ Significantly greater than ", local_authority, "(", year, ")  $ \\color[RGB]{195, 195, 255} \\blacksquare $ Significantly lower than ", local_authority, "
```"))

if (comparison_type == "Year") {
  
  main_year_significance_key <- asis_output(paste0("```{=latex}
...
```"))
  ...
  comparison_year_significance_key <- asis_output(paste0("```{=latex}
...
```"))
  ...
  main_year_significance_key <- NULL
  
  comparison_year_significance_key <- NULL
}
```

```{r}
comparison_year_significance_key
```
\pagebreak
...
Table_2.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.1)), escape = TRUE, booktabs = T)
 } else {
...
```
```{r eval=eval_comparison_time_series}
comparison_la_significance_key
```
\pagebreak
...
Table_2.2 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.2)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.3 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.3)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_2.1 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_2.1)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_2.2 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_2.2)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
kable("latex", col.names = gsub("blank", "", colnames(Table_2.4_Figure_2.3)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.5)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.6 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.6)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_2.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_2.4)), escape = TRUE, booktabs = T) %>% kable_styling(latex_options = "scale_down") %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_2.4 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_2.4)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em") %>% kable_styling(latex_options = "scale_down")
}
} else {
  asis_output("### There is no data to show for this table within the specified parameters.")
}
...
Table_2.7 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.7)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Figure_2.5 %>%
kable("latex", col.names = gsub("blank", "", colnames(Figure_2.5)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.8 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.8)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.9 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.9)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.10 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.10)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.11 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.11)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.12 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.12)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.13 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.13)), escape = TRUE, booktabs = T) %>% column_spec(1, width = "20em")
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.14 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.14)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.15 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.15)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.16 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.16)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
...
Table_2.17 %>%
kable("latex", col.names = gsub("blank", "", colnames(Table_2.17)), escape = TRUE, booktabs = T)
 } else {
        asis_output("### There is no data to show for this table within the specified parameters")
      }
```
