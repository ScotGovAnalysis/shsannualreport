...
`All (Gender)` = cell_spec(`All (Gender)`, "latex", background = case_when(`All (Gender)_sig` == "HIGHER" ~ "#00A3A3", `All (Gender)_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF")),
...
`All (Age)` = cell_spec(`All (Age)`, "latex", background = case_when(`All (Age)_sig` == "HIGHER" ~ "#00A3A3", `All (Age)_sig` == "LOWER" ~ "#C3C3FF", TRUE ~ "#FFFFFF"))
...
`All (Gender)` = cell_spec(`All (Gender)`, "latex", background = case_when(`All (Gender)_sig` == "HIGHER" ~ "#C3C3FF", `All (Gender)_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF")),
...
`All (Age)` = cell_spec(`All (Age)`, "latex", background = case_when(`All (Age)_sig` == "HIGHER" ~ "#C3C3FF", `All (Age)_sig` == "LOWER" ~ "#00A3A3", TRUE ~ "#FFFFFF"))) %>%
        select(!tidyselect::all_of(significance_column_names)) %>%
        kable("latex", escape = FALSE, booktabs = T)
```
