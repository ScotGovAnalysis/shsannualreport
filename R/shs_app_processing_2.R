...
#'
#' @param top_level_directory \code{string}. The path of the directory the app was created in in \code{shs_app_processing_1}.
#' @param reports_start_year \code{string}. The first year available to select in the report generator.
#' @param reports_end_year \code{string}. The final year available to select in the report generator.
#'
#' @return \code{null}.
#'
#' @examples
#' \dontrun{
#' shs_app_processing_2(top_level_directory, reports_start_year, reports_end_year)
#' }
#'
#' @export
