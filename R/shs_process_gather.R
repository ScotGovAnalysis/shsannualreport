#' Process Figure 6.1 LA
#'
#' \code{shs_process_fig_6.1} performs all processing for Figure 6.1 SHS survey data.
#' This will be made into a generic function for all similar figures in time.
#'
