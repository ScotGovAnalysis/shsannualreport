...
Read our [2018 Key Findings] (https://www.gov.scot/publications/scottish-household-survey-key-findings-2018/) for the latest analysis provided by the Scottish Household Survey. 
...
The data is divided into 12 topics. Use the drop-down boxes in the 'Survey results' tab to select a topic and question. You can also select which geographical area and year you want to look at. The default setting is Scotland-wide data from the most recent year. 
...
#### Exporting Data
You can download the tables and charts in the 'Survey data' tab. If you want to print all chapters for a specific topic and local authority, you can do so in the 'Create Report' tab. You can copy and export all data for a specific question in the 'Data' tab.
...
#### Base Totals 
All tables have a descriptive and numerical base. These show the population or population sub-group examined in it. We have calculated all results using weighted data, but the bases shown give the unweighted counts.
...
#### Survey Overview
The survey has run since 1999. Between 1999 and 2011 the survey design was consistent with data being collected in a two-year cycle. From 2012 onwards, the survey was redesigned. The new survey uses a fully unclustered core and modular structure with some questions asked of the full sample and others of a one-third sub-sample. 
...
#### Data Collection
The Scottish Household Survey social interview is carried out using Computer Aided Personal Interviewing (CAPI), and is in two parts; Household and Randum Adult. There is a follow-up component of a 'Physical Survey' of the dwelling. This is conducted by a professional surveyor through a visual inspection of the dwelling.

#### Survey Response
**In 2018, the SHS response rate was 64%**, which accounts to 10,530 interviews conducted. 

#### Survey Weighting
The weighting methodology was developed by the Scottish Government working with the Methodology Advisory Service at the Office for National Statistics. The Scottish Household Survey weighting procedures incorporate a selection weighting stage to address the unequal selection probabilities and calibration weighting to correct for non-bias. Calibration weighting derives weights such that the weighted survey totals match unknown population totals. 
...
#### Version Control 
Below is a summary of all the changes made to this website.
